...
-keepclassmembernames class com.j1j2.jposlauncher.data.model.** { *; }   #转换JSON的JavaBean，类成员名称保护，使其不被混淆

##################################################################
# 下面都是项目中引入的第三方 jar 包。第三方 jar 包中的代码不是我们的目标和关心的对象，故而对此我们全部忽略不进行混淆。
##################################################################
#---------------Begin: proguard configuration for android support扩展包 ----------
-dontwarn android.support.**
-keep class android.support.** { *; }
#---------------End: proguard configuration for android support扩展包 ----------
...
##---------------End: proguard configuration for okio、okhttp  ----------
...
#---------------Begin: proguard configuration for ARouter ----------
